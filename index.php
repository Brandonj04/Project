    ...
    <a class="navbar-brand" href="#">Home</a>
      ...
      <ul class="navbar-nav ms-auto">
        ...
        if (isset($_SESSION['user'])): ?>
          <li class="nav-item"><a class="nav-link" href="profile.php">Profile <?= $_SESSION['user']['name'] ?></a></li>
...
<div class="container my-5">
  <h4 class="text-center">How ShopSmart Works</h4>
  <div class="ratio ratio-16x9">
    <iframe src="https://www.youtube.com/embed/dQw4w9WgXcQ" title="ShopSmart Video Demo" allowfullscreen></iframe>
  </div>
</div>
...
<script>
  // Load Google Map
  function initMap() {
    const location = { lat: 42.3001, lng: -83.0165 };
